...
# 创建并训练XGBoost模型
xgb_params = {
  'eta': 0.5197128365147241,
    'gamma': 5.412963353010705,
    'max_depth': 1,
    'min_child_weight': 7,
    'n_estimators': 72,
    'subsample': 0.7140869321324278,
}
...
# 创建Web应用程序
st.title("2-year survival of mEC patients based on XGBoost")
...
if st.button("Predict"):
    ...
    st.write("Probability of 2-year survival is:", probability)
